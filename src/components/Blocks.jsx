...
export function BlockList({ blocks, onChange, edit, context, pages, onNavigate, addLabel = 'Add blocks' }) {
  ...
  return (
    <>
      ...
      {edit && <AddBar types={types} onAdd={add} mini={context !== 'page'} label={addLabel} />}
    </>
  )
}
